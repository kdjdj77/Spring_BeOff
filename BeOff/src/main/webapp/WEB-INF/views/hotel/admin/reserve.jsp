                        ...
                        <div class="address">
                            ...
                            <div class=" my-3">
                                ...
                                <div class="inputWithcheck">
                                    <input class="form-control" type="text" value="2022/12/12 ~ 2022/12/13" readonly>
                            ...
                            <div class="d-flex flex-column dis">
                                ...
                                <input type="hidden" name="id" value="${r.id }">
               					<input class="btn btn-warning btn-xl text-uppercase" type="button" onclick="requestPay('${r.hotel.hotelname}', '${r.price}')" value="카카오페이">
                            </div>
                        </div>
                	</form>
               </div>
